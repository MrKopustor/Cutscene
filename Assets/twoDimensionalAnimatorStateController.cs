...
public class twoDimensionalAnimatorStateController : MonoBehaviour
{
    ...
    void Start()
    {
        // search the gameobject this this script is attached to and get the animator component
        ...
        float currentMaxVelocity)
    {
        ...
        // decrease velocityX if reght is not pressed and velociteX > 0
        ...
        float currentMaxVelocity)
    {
        ...
        //round to the currentMaxVelocity if within offset
        else if (leftPressed && velocityX > -currentMaxVelocity && velocityZ < (-currentMaxVelocity + 0.05f))
        {
            velocityX = -currentMaxVelocity;
        }
        ...
        //round to the currentMaxVelocity if within offset
        else if (rightPressed && velocityX < currentMaxVelocity && velocityZ > (currentMaxVelocity - 0.05f))
        {
            velocityX = currentMaxVelocity;
        }
